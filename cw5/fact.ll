...
define fastcc i32 @fact(i32 %n) {
    %tmp.0 = add i32 0, 0
    %tmp.1 = tail call i1 @builtin.icmp.eq(i32 %n, i32 %tmp.0)
    %tmp.5 = alloca i32
    br i1 %tmp.1, label %bb.3, label %bb.2

bb.3:
    %tmp.6 = add i32 0, 1
    store i32 %tmp.6, ptr %tmp.5
    br label %bb.4

bb.2:
    %tmp.7 = add i32 0, 1
    %tmp.8 = tail call i32 @builtin.isub(i32 %n, i32 %tmp.7)
    %tmp.9 = tail call i32 @fact(i32 %tmp.8)
    %tmp.10 = tail call i32 @builtin.imul(i32 %n, i32 %tmp.9)
    store i32 %tmp.10, ptr %tmp.5
    br label %bb.4

bb.4:
    %tmp.11 = load i32, ptr %tmp.5
    ret i32 %tmp.11
}

define fastcc i32 @facT(i32 %n, i32 %acc) {
    %tmp.0 = add i32 0, 0
    %tmp.1 = tail call i1 @builtin.icmp.eq(i32 %n, i32 %tmp.0)
    %tmp.5 = alloca i32
    br i1 %tmp.1, label %bb.3, label %bb.2
...
bb.3:
    store i32 %acc, ptr %tmp.5
    br label %bb.4

bb.2:
    %tmp.6 = add i32 0, 1
    %tmp.7 = tail call i32 @builtin.isub(i32 %n, i32 %tmp.6)
    %tmp.8 = tail call i32 @builtin.imul(i32 %n, i32 %acc)
    %tmp.9 = tail call i32 @facT(i32 %tmp.7, i32 %tmp.8)
    store i32 %tmp.9, ptr %tmp.5
    br label %bb.4

bb.4:
    %tmp.10 = load i32, ptr %tmp.5
    ret i32 %tmp.10
}

define fastcc i32 @facTi(i32 %n) {
    %tmp.0 = add i32 0, 1
    %tmp.1 = tail call i32 @facT(i32 %n, i32 %tmp.0)
    ret i32 %tmp.1
}

define fastcc void @top() {
    %tmp.0 = add i32 0, 6
    %tmp.1 = tail call i32 @fact(i32 %tmp.0)
    tail call void @print_int(i32 %tmp.1)
    %tmp.3 = add i32 0, 44
    tail call void @print_char(i32 %tmp.3)
    %tmp.5 = add i32 0, 6
    %tmp.6 = tail call i32 @facTi(i32 %tmp.5)
