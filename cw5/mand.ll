...
bb.3:
    tail call void @print_star()
    br label %bb.4

bb.2:
    %tmp.7 = fadd double 0.0, 4.0
    %tmp.8 = tail call double @builtin.fmul(double %zi, double %zi)
    %tmp.9 = tail call double @builtin.fmul(double %zr, double %zr)
    %tmp.10 = tail call double @builtin.fadd(double %tmp.8, double %tmp.9)
    %tmp.11 = tail call i1 @builtin.fcmp.ule(double %tmp.7, double %tmp.10)
    br i1 %tmp.11, label %bb.13, label %bb.12

bb.13:
    tail call void @print_space()
    br label %bb.14

bb.12:
    %tmp.17 = add i32 0, 1
    %tmp.18 = tail call i32 @builtin.iadd(i32 %m, i32 %tmp.17)
    %tmp.19 = tail call double @builtin.fmul(double %zr, double %zr)
    %tmp.20 = tail call double @builtin.fadd(double %x, double %tmp.19)
    %tmp.21 = tail call double @builtin.fmul(double %zi, double %zi)
    %tmp.22 = tail call double @builtin.fsub(double %tmp.20, double %tmp.21)
    %tmp.23 = fadd double 0.0, 2.0
    %tmp.24 = tail call double @builtin.fmul(double %tmp.23, double %zr)
    %tmp.25 = tail call double @builtin.fmul(double %tmp.24, double %zi)
    %tmp.26 = tail call double @builtin.fadd(double %tmp.25, double %y)
    tail call void @m_iter(i32 %tmp.18, double %x, double %y, double %tmp.22, double %tmp.26)
    br label %bb.14
...
bb.3:
    ...
    %tmp.9 = load double, ptr @Ystep
    %tmp.10 = tail call double @builtin.fadd(double %y, double %tmp.9)
    tail call void @y_iter(double %tmp.10)
    br label %bb.4
