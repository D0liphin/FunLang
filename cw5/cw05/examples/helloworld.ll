...
define fastcc void @gprint({ ptr, i64 } %s) {
    %tmp.0 = add i32 0, 27
    %tmp.1 = alloca i1
    store i1 true, ptr %tmp.1
    %tmp.2 = load i1, ptr %tmp.1
    tail call void @builtin.iwrite(i32 %tmp.0, i1 %tmp.2)
    %tmp.4 = load { ptr, i64 }, ptr @GLOBAL.5
    tail call void @builtin.swrite({ ptr, i64 } %tmp.4)
    tail call void @builtin.swrite({ ptr, i64 } %s)
    %tmp.7 = add i32 0, 27
    %tmp.8 = alloca i1
    store i1 true, ptr %tmp.8
    %tmp.9 = load i1, ptr %tmp.8
    tail call void @builtin.iwrite(i32 %tmp.7, i1 %tmp.9)
    %tmp.11 = load { ptr, i64 }, ptr @GLOBAL.6
    tail call void @builtin.swrite({ ptr, i64 } %tmp.11)
    ret void
}

define fastcc void @main() {
    %tmp.0 = load { ptr, i64 }, ptr @GLOBAL.7
    tail call void @builtin.swrite({ ptr, i64 } %tmp.0)
    %tmp.2 = load { ptr, i64 }, ptr @GLOBAL.8
    tail call void @builtin.swrite({ ptr, i64 } %tmp.2)
    %tmp.4 = load { ptr, i64 }, ptr @GLOBAL.9
    tail call void @gprint({ ptr, i64 } %tmp.4)
    ret void
}
...
@sbuf.GLOBAL.8 = constant [36 x i8] c"\68\65\72\65\20\61\72\65\20\73\6F\6D\65\20\63\72\61\62\73\3A\20\F0\9F\A6\80\20\F0\9F\A6\80\20\F0\9F\A6\80\0A"
@GLOBAL.8 = constant { ptr, i64 } { ptr @sbuf.GLOBAL.8, i64 36 }
...
@sbuf.GLOBAL.9 = constant [11 x i8] c"\74\68\61\6E\6B\20\79\6F\75\21\0A"
@GLOBAL.9 = constant { ptr, i64 } { ptr @sbuf.GLOBAL.9, i64 11 }

@sbuf.GLOBAL.6 = constant [3 x i8] c"\5B\30\6D"
@GLOBAL.6 = constant { ptr, i64 } { ptr @sbuf.GLOBAL.6, i64 3 }

@sbuf.GLOBAL.7 = constant [25 x i8] c"\E3\81\93\E3\82\93\E3\81\AB\E3\81\A1\E3\81\AF\E4\B8\96\E7\95\8C\EF\BC\81\0A"
@GLOBAL.7 = constant { ptr, i64 } { ptr @sbuf.GLOBAL.7, i64 25 }

@sbuf.GLOBAL.5 = constant [6 x i8] c"\5B\30\3B\33\32\6D"
@GLOBAL.5 = constant { ptr, i64 } { ptr @sbuf.GLOBAL.5, i64 6 }
