...
define fastcc void @hanoi(i32 %n, i32 %a, i32 %b, i32 %c) {
    %tmp.0 = add i32 0, 0
    %tmp.1 = tail call i1 @builtin.icmp.ne(i32 %n, i32 %tmp.0)
    br i1 %tmp.1, label %bb.3, label %bb.2

bb.3:
    %tmp.6 = add i32 0, 1
    %tmp.7 = tail call i32 @builtin.isub(i32 %n, i32 %tmp.6)
    tail call void @hanoi(i32 %tmp.7, i32 %a, i32 %c, i32 %b)
    tail call void @print_int(i32 %a)
    %tmp.10 = add i32 0, 45
    tail call void @print_char(i32 %tmp.10)
    %tmp.12 = add i32 0, 62
    tail call void @print_char(i32 %tmp.12)
    tail call void @print_int(i32 %b)
    %tmp.15 = add i32 0, 10
    tail call void @print_char(i32 %tmp.15)
    %tmp.17 = add i32 0, 1
    %tmp.18 = tail call i32 @builtin.isub(i32 %n, i32 %tmp.17)
    tail call void @hanoi(i32 %tmp.18, i32 %c, i32 %b, i32 %a)
    br label %bb.4
...
define fastcc void @main() {
    ...
    %tmp.2 = add i32 0, 2
    %tmp.3 = add i32 0, 3
    tail call void @hanoi(i32 %tmp.0, i32 %tmp.1, i32 %tmp.2, i32 %tmp.3)
    ret void
}
